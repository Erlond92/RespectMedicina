          ...
          {reviewList.map((review, index) => {
            return (
              <tr key={index}>
                ...
                <td className={style.Table__date}>{review.date_visit}</td>
                <td className={style.Table__rate}>
                  <Rate rate={review.rate} />
                </td>
                <td>
                  <Bonus isBonus={review.bonus} />
                </td>
                <td>
                ...
                <td className={style.Table__date}>{review.date_review}</td>
                <td>
                  <Remove onClick={() => {}} />
                </td>
              </tr>
